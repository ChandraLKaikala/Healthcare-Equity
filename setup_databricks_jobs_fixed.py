#!/usr/bin/env python3
"""
Setup Databricks Jobs via REST API - Correct Endpoint
"""
import os
import sys
import requests
...
# Use /api/2.0/jobs/create endpoint
base_url = f"{host}/api/2.0/jobs/create"
