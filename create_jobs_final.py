#!/usr/bin/env python3
"""
Create Databricks Jobs using Python SDK - Final Version
"""
import os
import sys
sys.path.insert(0, '.')
    ...
    jobs_config = [
        {
            ...
            "query": "SELECT scenario_type, race, gender, approval_rate, total_decisions FROM healthcare_equity_gold.bias_metrics LIMIT 100",
            "cron": "0 0 * * ?",
        ...
        },
        {
            ...
            "query": "SELECT COUNT(*) as record_count, AVG(approval_rate) as avg_approval FROM healthcare_equity_gold.bias_metrics",
            "cron": "0 0 ? * MON",
