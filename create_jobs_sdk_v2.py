#!/usr/bin/env python3
"""
Create Databricks Jobs using Python SDK - Version 2
"""
import os
import sys
sys.path.insert(0, '.')
...
try:
    ...
    jobs_config = [
        ...
        },
        {
            ...
            "query": "SELECT COUNT(*) as patients FROM healthcare_equity_bronze.patients UNION ALL SELECT COUNT(*) FROM healthcare_equity_silver.patients_processed",
            "cron": "0 */6 * * ?",
    ...
    for job_config in jobs_config:
        try:
            ...
            # Use create method with job dict
            job_dict = {
            ...
            # Create the job
            response = client.jobs.create(**job_dict)
